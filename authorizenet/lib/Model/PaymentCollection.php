 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentCollection implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PaymentCollection';
    ...
    {
        $this->container['_link'] = isset($data['_link']) ? $data['_link'] : null;
