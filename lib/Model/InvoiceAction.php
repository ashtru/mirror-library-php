 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InvoiceAction implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("Send", "Cancel");
    ...
    public function setAction($action)
    {
        ...
        if (!in_array($action, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'action', must be one of 'Send', 'Cancel'");
        }
