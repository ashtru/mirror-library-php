...
class PaymentsApi
{
     ...
     * .
     *
     * @param \authorizenet_rest\Model\PaymentRequest $payment_request charge credit card model (required)
     ...
     * @param string $authorization The value to provide in the Authorization header of ANET API request (optional)
     *
     * @return \authorizenet_rest\Model\PaymentCollection
     * @throws \authorizenet_rest\ApiException on non-2xx response
     */
     ...
     * @param string $authorization The value to provide in the Authorization header of ANET API request (optional)
     *
     * @return Array of \authorizenet_rest\Model\PaymentCollection, HTTP status code, HTTP response headers (array of strings)
     * @throws \authorizenet_rest\ApiException on non-2xx response
     */
    public function getAllPaymentsWithHttpInfo($authorization = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\authorizenet_rest\Model\PaymentCollection'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\authorizenet_rest\Model\PaymentCollection', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\authorizenet_rest\Model\PaymentCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
