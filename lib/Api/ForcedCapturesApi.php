...
/**
 * ForcedCapturesApi Class Doc Comment
 *
 * @category Class
 * @package  authorizenet_rest
 * @author   http://github.com/swagger-api/swagger-codegen
...
class ForcedCapturesApi
{
    ...
    /**
     * Operation createAForcedCapture
     *
     * .
     *
     * @param \authorizenet_rest\Model\ForcedCaptureRequest $body  (required)
     ...
     */
    public function createAForcedCapture($body, $authorization = null)
    {
        list($response) = $this->createAForcedCaptureWithHttpInfo($body, $authorization);
        return $response;
    }


    /**
     * Operation createAForcedCaptureWithHttpInfo
     *
     * .
     *
     * @param \authorizenet_rest\Model\ForcedCaptureRequest $body  (required)
     ...
     * @throws \authorizenet_rest\ApiException on non-2xx response
     */
    public function createAForcedCaptureWithHttpInfo($body, $authorization = null)
    {
        
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling createAForcedCapture');
        }

        // parse inputs
        $resourcePath = "/forcedcaptures";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
