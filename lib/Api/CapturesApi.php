...
class CapturesApi
{
    ...
    {
        list($response) = $this->createACaptureWithHttpInfo($payment_id, $body, $authorization);
        return $response;
    }


    /**
     * Operation createACaptureWithHttpInfo
     *
     * .
     *
     * @param string $payment_id  (required)
    ...
    public function createACaptureWithHttpInfo($payment_id, $body, $authorization = null)
    {
        ...
        if ($payment_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $payment_id when calling createACapture');
        }

        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling createACapture');
        }

        // parse inputs
        $resourcePath = "/payments/{paymentId}/captures";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
